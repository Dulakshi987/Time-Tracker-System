...
function ViewDetailsPopup({
  ...
  const isFlagged =
    (doc.hasWrongMaterial || "").toUpperCase() ===
    "YES";
    ...
    async (
      ...
      try {
        const res = await fetch(
          `${API_BASE}?page=${requestedPage}&size=${pageSize}`
        );
        ...
        // Supports old array response AND new paginated response.
        ...
        console.error(
          "Failed to fetch Pick Portal documents:",
          err
        );
